...
export default class App extends Component {
  ...
  createNote=()=>{
    let newNote={...this.state};//spread in javascript(..if we change the content of newNote,it does not change the content of this.state)
  ...
  render() {
    return (
      <div>
        <NoteNavbar value={this.state.nameValue} save={this.saveName} create={this.createNote}/>
